  ...
  private handleRoleChanges(): void {
    ...
    this.registrationForm.get('role')?.valueChanges.subscribe(role => {
      ...
      if (role === 'driver') {
        ...
        this.registrationForm.get('vehicleName')?.setValidators([
          Validators.required,
          GeneralValidators.noWhitespace
        ]);

        this.registrationForm.get('maxSeats')?.setValidators([
          Validators.required,
          VehicleValidators.maxSeats
        ]);

        this.registrationForm.get('vehicleLicense')?.setValidators([
          Validators.required,
          VehicleValidators.validLicense
        ]);
